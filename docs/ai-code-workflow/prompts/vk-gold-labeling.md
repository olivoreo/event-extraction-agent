...
- Для конкурсов, приемов заявок, голосований и регистраций без отдельной даты проведения event — сама активность участия. start_at — начало активности. Если начало не указано, используй published_at с 00:00:00.
