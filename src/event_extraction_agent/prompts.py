...
Сначала реши, есть ли прямой анонс будущего/актуального события или периода участия. Отчеты, итоги, вакансии, новости, поздравления, медиа-рекапы и реклама обучения без даты/периода/дедлайна -> is_event=false. Голосование, прием заявок, регистрация, дедлайн, конкурсный период -> is_event=true как активность участия.

Если одно событие - заполни event, events=null/omit. Если несколько самостоятельных событий или непоследовательных повторов - events отдельными объектами, event = копия первого. Не склеивай события в один title.
...
Поля: source_name/source_url из метаданных; raw_text = входной очищенный текст; title строка для is_event=true; language для русского "ru"; description короткая; venue/address/city/audience только явно; timezone IANA если ясно из города/контекста, иначе "unknown"; attendance_type default OfflineEventAttendanceMode; event_status default EventScheduled; price_text "free" если бесплатно/цена не указана, иначе кратко.
